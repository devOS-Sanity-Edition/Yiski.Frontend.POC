...
public class ModerationLogsViewModel : ViewModelBase {
    ...
    public ModerationLogsViewModel() {
        ModerationEntries = new ObservableCollection<ModerationLogItem>();

        ModerationEntries.Add(new ModerationLogItem {
        ...
        ModerationEntries.Add(
            new ModerationLogItem {
                ...
                InfractionType = InfractionType.BAN,
                Reason =
                    "what the fuck is this video https://cdn.discordapp.com/attachments/1124489713886167122/1297938374941872299/bark-bark.mp4?ex=6717becf&is=67166d4f&hm=62908fbbb05e68e15a185c29d77103a1e6a006311183746de523010ba9727c05&",
                ModeratorId = 942533628435501076,
